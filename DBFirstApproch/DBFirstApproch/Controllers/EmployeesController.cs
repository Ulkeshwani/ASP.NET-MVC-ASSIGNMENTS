...
namespace DBFirstApproch.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpNo,EmpName,Designation,DeptNo,Salary")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpNo,EmpName,Designation,DeptNo,Salary")] Employee employee)
        {
            if (ModelState.IsValid)
            {
